...
class CommentController extends Controller
{
    ...
    {
        $redisKey = 'comment:class:' . $classcode . ':' . $id;
        $comments = DB::table('comments')->where('classcode', $classcode)->where('is_delete', false)->leftJoin('users', 'comments.username', '=', 'users.username')->orderByDesc('post_id')->get(['users.name', 'comments.text', 'comments.comment_id', 'comments.post_id', 'comments.classcode', 'comments.created_at', 'comments.updated_at', 'users.role']);
